...
group_names = {
    ...
    "4": ["STAMP-4","RPM-4","vel_decimal_[]","Ignition_[°AMPS]","Binary_block-4"],
    "5": ["STAMP-5","RPM-5","EVAP_[%]","Consumption_[%]","Empty"],
    "6": ["STAMP-6","Lambda_[#]","Empty","Empty","Empty"],
    "7": ["STAMP-7","Empty","Empty","Empty","Empty"],
    "1-b": ["STAMP-1","RPM","Intake_temp_[°C]","lambda_[V]","Binary_block-1"],
...
BLOQUE_01_DATA = [
    ...
    {"Field": "H", "Code": "0", "Function": "Engine temperature above 80°"},
    {"Field": "H", "Code": "1", "Function": "Engine temperature below 80°"},
]
...
def html_metadata(data):
    ...
    componentes.append(
        html.H5("📊 File metada", className="mb-3 text-primary")
    )
